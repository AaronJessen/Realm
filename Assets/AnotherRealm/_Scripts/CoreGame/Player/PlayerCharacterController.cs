...
namespace ARExplorer
{
    ...
    public class PlayerCharacterController : MonoBehaviour
    {
        ...
        [SerializeField]
        PlayerHealthBar PlayerHealthBarScr;
        ...
        public void ShotToggle(bool shot)
        {
            //playerWeaponsManagerScr.Shot();
            if (shot)
            {
                PlayerHealthBarScr.UpdateBattertBar(1);
            }
            playerWeaponsManagerScr.SpotLightToggle(shot);
        }
        //[Header("Movement")]
